...
public class Tester21 {
    ...
    private By newElement = By.xpath("//form[@id='tsf']/div[2]/div/div[3]/center");  
    ...
    public RemoteWebElement getNewElement(){

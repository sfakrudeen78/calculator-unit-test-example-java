...
,    private By add = By.name("name=btnK");  
      

    public RemoteWebElement getTab(){
        return driver.findElement(tab);
    }      
,    public RemoteWebElement getAdd(){

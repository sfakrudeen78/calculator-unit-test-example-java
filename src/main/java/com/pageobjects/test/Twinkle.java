...
,    private By tabee = By.name("name=btnI");  
      

    public RemoteWebElement getTab(){
        return driver.findElement(tab);
    }      
,    public RemoteWebElement getTabee(){
        return driver.findElement(tabee);
    }      
}
